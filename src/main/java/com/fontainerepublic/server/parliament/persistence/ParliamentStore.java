...
/**
 * Persistence boundary of the authoritative {@code "parliament"} namespace
 * (FR-PAR-001-A §3.4).
 *
 ...
 * commit gate and returns its result. Every mutation of the parliament store
 * goes through the acknowledged path — an ordinary non-acknowledged save does
 * not exist here because legislative state must never be published before
 * durability success.</p>
 */
public interface ParliamentStore {
