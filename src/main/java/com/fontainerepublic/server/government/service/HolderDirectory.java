...
/**
 * Holder/actor resolution boundary of the government module (FR-GOV-001-A §4).
 *
 ...
 * by the government module after runtime start; until bound, every query
 * reports unavailable and mutations fail closed.</p>
 */
