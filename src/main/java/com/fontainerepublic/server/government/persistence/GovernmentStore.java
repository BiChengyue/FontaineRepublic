...
/**
 * Persistence boundary of the authoritative {@code "government"} namespace
 * (FR-GOV-001-A §3.4).
 *
 ...
 * commit gate and returns its result. Every mutation of the government store
 * goes through the acknowledged path — an ordinary non-acknowledged save does
 * not exist here because government state must never be published before
 * durability success.</p>
 */
public interface GovernmentStore {
